...
const Login = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    if (loginData.email !== '' && loginData.password !== '') {
      if (page === 'login') {
        ...
        console.log('add forgot password logic here');
      }
    } else {
  ...
  return (
    <div className="h-screen w-screen flex flex-col md:flex-row items-center justify-start p-[1.5rem] lg:px-[5rem]">
      ...
      >
        <motion.div
          className={`h-1/3 w-full flex items-center justify-center text-lightGreen gap-[10px] p-[1rem] ${
            page === 'login' ? 'shadowPop' : ''
          }`}
          whileHover={{
