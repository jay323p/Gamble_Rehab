...
const Hero = () => {
  ...
  return (
    <div className="h-[48%] text-white flex justify-around mt-1 md:mt-10 md:h-[80%] mb-3 md:mb-[-1rem]">
        ...
        <div className="flex justify-center w-full h-full relative ">
          ...
          <div className="absolute">
            ...
            >
              ...
              <div className="hero-border-bright absolute left-[-170px] top-[40px] bg-slate-400 opacity-70 text-black flex gap-4 items-center h-[100px] w-[300px] p-[5px] md:left-[-300px] md:w-[400px] font-bold">
                <IconContext.Provider
