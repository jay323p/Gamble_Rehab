...
const HouseEdgeTextBox = () => {
  ...
  const setActiveText = (e) => {
    ...
    console.log(typeof btnTextToNum);
  };
      ...
      <div ref={ref} className="flex flex-col items-center h-full relative">
        ...
        <div className="flex justify-center z-[100] text-white  ml-auto mr-auto w-[90%] ">
          <motion.div
            ...
            className={` ${
              active === 1 ? 'text-brilliantGreen brightness-200' : 'bg-inherit'
          ...
          <motion.div
            whileHover={{ backgroundColor: 'rgba(0, 0, 0, 0.3)' }}
            className={` ${
              active === 2 ? 'text-brilliantGreen brightness-200' : 'bg-inherit'
            } flex-1 `}
          >
            <button
              className="h-[30px] w-full cursor-pointer"
          ...
          <motion.div
            whileHover={{ backgroundColor: 'rgba(0, 0, 0, 0.3)' }}
            className={` ${
              active === 3 ? 'text-brilliantGreen brightness-200' : 'bg-inherit'
